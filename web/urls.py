...
urlpatterns=[
	...
	path('menu_6/<str:page>/<int:post_pk>', views.detail_post, name='detail_post'),
	path('menu_6/<str:page>/<int:post_pk>/<str:name>/input', views.input_information_post_password, name='input_information_post_password'),
	path('menu_6/<str:page>/<int:post_pk>/<str:name>', views.edit_information, name='edit_information'),
